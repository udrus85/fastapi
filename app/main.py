...
- ✅ Избранные задачи и напоминания
...
Добавляйте токен в заголовок `Authorization: Bearer <token>` для защищённых endpoints.
    ...
    openapi_tags=[
        ...
        {"name": "Задачи", "description": "CRUD операции с задачами, поиск, фильтрация, экспорт"},
        {"name": "Категории", "description": "Управление категориями задач"},
        {"name": "Теги", "description": "Управление тегами для задач"},
    ]
)
